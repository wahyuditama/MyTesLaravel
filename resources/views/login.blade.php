...
<html
  ...
  data-assets/assets-path="{{'assets/assets/assets/assets'}}"
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <img src="https://cdn.worldvectorlogo.com/logos/laravel-2.svg" width="38" alt="">
                  <span class="app-brand-text text-primary demo text-body fw-bolder">Laravel Laundry</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to MyLaundry! 👋</h4>
